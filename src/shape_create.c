...
void subdivide(float* v1, float* v2, float* v3, unsigned int SubdivisionCoef,
    ...
    subdivide(v1, v12, v31, SubdivisionCoef - 1, points_array, index_array, ip, is);
    subdivide(v2, v23, v12, SubdivisionCoef - 1, points_array, index_array, ip, is);
    subdivide(v3, v31, v23, SubdivisionCoef - 1, points_array, index_array, ip, is);
    subdivide(v12, v23, v31, SubdivisionCoef - 1, points_array, index_array, ip, is);
}
...
void create_sphere(unsigned int nb_subdivision, float sphere_points_array[], unsigned int sphere_points_index[],
    ...
    for(int i = 0; i < 20; i++){
        ...
        subdivide(v1, v2, v3, nb_subdivision, sphere_points_array, sphere_points_index, ip, is);
    }
}
